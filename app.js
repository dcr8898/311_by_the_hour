...
(function (app) {
    ...
    var options = {
        ...
        subtitle: {
            text: "NYC 311 call data by complaint type and the hour of day in "
                + "which calls were placed for the week ending "
                + "<input id='date-select' type='date' value='2010-08-03' "
                + "min='2010-01-01'><br/>[Inspired by <a "
...
//     var categoryIndexes = categories.reduce(function(indexes, category, i) {
//         indexes[category] = i;
//         return indexes
//     }, {});
...
//                     var index = categoryIndexes[category];
...
//             dummyOffset.showInLegend = false;
//             dummyOffset.fillColor = 'rgba(0,0,0,0)';
